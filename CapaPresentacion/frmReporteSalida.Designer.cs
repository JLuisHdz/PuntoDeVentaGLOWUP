...
{
    partial class frmReporteSalida
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            dgvdata.Columns.AddRange(new DataGridViewColumn[] { FechaRegistro, Nombre, Monto, Descripcion });
            dgvdata.EnableHeadersVisualStyles = false;
            dgvdata.Location = new Point(0, 54);
            dgvdata.MultiSelect = false;
            dgvdata.Name = "dgvdata";
            dgvdata.RowTemplate.Height = 25;
            dgvdata.Size = new Size(841, 292);
            dgvdata.TabIndex = 2;
            // 
            // FechaRegistro
            // 
            ...
            Controls.Add(panel2);
            Name = "frmReporteSalida";
            Text = "frmReporteSalida";
            Load += frmReporteSalida_Load;
