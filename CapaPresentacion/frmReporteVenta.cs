...
namespace CapaPresentacion
{
    public partial class frmReporteVenta : Form
    {
        ...
        {
            string Texto_Html = Properties.Resources.PlantillaReporteVenta.ToString();
            ...
            SaveFileDialog savefile = new SaveFileDialog();
            savefile.FileName = string.Format("ReporteVentas_{0}.pdf", DateTime.Now.ToString("dd-MM-yyyy"));
